...
def get_default_models():
  ...
  betas = h.sweep("vae.beta", h.discrete([1., 5., 16.]))
  ...
  c = h.sweep("annealed_vae.c_max", h.discrete([5., 50., 100.]))
  ...
  betas = h.sweep("beta_tc_vae.beta", h.discrete([1., 6., 10.]))
